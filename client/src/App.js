...
updatePhoneCounter(input) {
  ...
  if (counter) {
    ...
    // Cambiar color según la cantidad de dígitos
    if (length === 10) {
      counter.className = 'counter text-success';
    } else if (length >= 7) {
...
setupEventListeners() {
  ...
  document.addEventListener('input', (e) => {
    ...
    // Actualizar contador de teléfono
      ...
      <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
        <div class="card contact-card h-100">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title text-dark">${contact.nombre}</h5>
          ...
          <div class="card-footer bg-transparent">
            <small class="text-muted">
              ...
              Creado: ${new Date(contact.fechaCreacion).toLocaleDateString()}
            </small>
          </div>
        </div>
      </div>
  ...
  async handleSubmit(contactData) {
    try {
      ...
      const url = this.currentContact 
        ? `http://localhost:5000/api/contacts/${this.currentContact._id}`
